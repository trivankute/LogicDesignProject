...
unsigned char flag_timer0 = 0,flag_timer1 = 0,flag_timer2 = 0,flag_timer3 = 0,flag_timer_dung_yen=0,flag_timer_open_door=0;
unsigned int v_cnt0 = 0,v_cnt1 = 0;
unsigned int timer0_cnt = 0,timer1_cnt = 0,timer2_cnt = 0,timer3_cnt = 0,timer_dung_yen_cnt=0,timer_open_door_cnt=0;
unsigned int time0_MUL = 1,time1_MUL = 1,time2_MUL = 1,time3_MUL = 1,time_dung_yen_MUL=1,time_open_door_MUL=1;
...
void timer3_isr(void)
{
    ...
    if(timer_dung_yen_cnt>=time_dung_yen_MUL)
    {
        timer_dung_yen_cnt=0;
        flag_timer_dung_yen=1;
    }
    if(timer_open_door_cnt>=time_open_door_MUL)
    {
        timer_open_door_cnt=0;
        flag_timer_open_door=1;
    }
//    timerRun();
}
...
void setTimer_for_dung_yen(int time)
{
    time_dung_yen_MUL=time/10;
    timer_dung_yen_cnt = 0;
    flag_timer_dung_yen = 0;
}

void setTimer_for_open_door(int time)
{
    time_open_door_MUL=time/10;
    timer_open_door_cnt = 0;
    flag_timer_open_door = 0;
}
